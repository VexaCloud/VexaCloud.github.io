    ...
    const TUTORIAL_STEPS = [
      {
        ...
        desc: "A quick tutorial on how to use all the features.",
        target: null,
        placement: "center",
      },
      {
        ...
        title: "Your servers",
        desc: "Servers are the communities you belong to. They’re listed along the left. Click one to open it, or use + to create your own private server where you can invite people and moderate. Use the world to browse public ones.",
      ...
      },
      {
        ...
        title: "Channels",
        desc: "Inside a server, channels are message/voice streams. Text channels show a #; pick one to open the conversation in the main panel.",
      ...
      },
      {
        ...
        desc: "Voice channels appear in the same list. Click one to join a live call.",
      ...
      },
      {
        ...
        title: "Messages",
        desc: "The main area shows the current channel’s messages. Newer messages appear at the bottom. You can upload and paste files as well.",
      ...
      },
      {
        ...
        title: "Write & send",
        desc: "Type in the box at the bottom and press enter or the send button to send a message.",
      ...
      },
      {
        ...
        desc: "Right‑click a message to reply or react with an emoji. Type @ to mention someone else in the server.",
      ...
      },
      {
        ...
        desc: "DMs let you privately chat one‑on‑one outside any server. Open them from the top bar anytime. You can also do one-on-one voice and video calls from here.",
        target: "#dm-button",
        placement: "bottom",
      },
      {
        ...
        title: "Notifications",
        desc: "The bell turns on push notifications. You can open full notification settings for more controls.",
      ...
      },
      {
        ...
        title: "Members",
        desc: "See who’s in the current server. You can also see whos online and view peoples profiles by pressing on them.",
      ...
      },
      {
        ...
        title: "Themes",
        desc: "Switch your visuals from the theme dropdown in the top bar. “More themes…” opens extra looks. You can also customize your theme and text color in settings.",
        target: "#theme-select",
        placement: "bottom",
      },
      {
        ...
        desc: "Click your avatar or name to open settings. You can control your account and visuals from here. You can also contact support by going to the account section of settings.",
        target: "#user-pill",
        placement: "bottom",
      },
    ];
